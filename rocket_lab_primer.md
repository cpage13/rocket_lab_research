...
Neutron's reuse strategy is worth understanding, because it is not just a smaller Falcon 9. Rocket Lab designed it around one idea: **a large majority of a rocket's cost sits in the first stage** (the engines and the booster), so it brings the expensive parts home and makes the rest cheap. Its distinctive **"Hungry Hippo" fairings stay attached to the first stage**: they open to release the upper stage and payload, then close and fly back for reuse, instead of being jettisoned and discarded the way fairings are on almost every other rocket. That leaves the **second stage as the only expendable part, and it is deliberately cheap**, a lightweight structural tank with a single engine that the fairings shield through the hardest part of the climb. Falcon 9 reuses its booster but still throws away a costlier upper stage every flight, and most rockets discard their fairings too. Where SpaceX's Starship is chasing full, rapid reuse of both stages (a bigger bet still being proven), Neutron takes the pragmatic middle path: reuse everything expensive, the engines, the booster, even the fairings, and expend only something cheap. If it works, that is an unusually efficient cost structure, arguably smarter than Falcon 9's.
