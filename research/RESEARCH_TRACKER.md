...
| [economics/operating_margins_and_revenue_multiple_2026.md](economics/operating_margins_and_revenue_multiple_2026.md) | draft | Validates the 1.5x revenue multiple: R=1.5 (33.3% gross) is fair to conservative vs comparable operators (Oracle OCI ~32%, hyperscaler operating 33-45%); band edges 1.2/1.8 map to commodity floor / pricing-power ceiling. Distinguishes gross (= the R markup) from operating and net; documents the scaling depreciation-timing wedge (neoclouds compress, hyperscalers expand). | Added 2026-05-30. Multi-sourced (CoreWeave, Nebius, Oracle, AWS/Azure/GCP, NVIDIA, 2024-2026); replaces the stale Oracle 30-40% figure in revenue_economics_2026.md; supports RLDC-REVENUE-MULTIPLE-1_5X / REV-008. |
