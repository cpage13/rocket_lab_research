...
| [economics/operating_margins_and_revenue_multiple_2026.md](economics/operating_margins_and_revenue_multiple_2026.md) | Operating vs gross margin, GPU-cloud operator margins and multiples, and validation of the 1.5x revenue multiple. | R=1.5 (33.3% gross, a 50% markup over amortized cost) is fair to mildly conservative: inside the comparable gross-margin band (Oracle OCI ~32%, hyperscaler cloud operating 33-45%); band edges map cleanly (1.2 = commodity floor ~17%, 1.8 = pricing-power ceiling ~44%). R is a markup, hence a GROSS margin, not operating or net. Rapid scaling compresses OPERATING margins (a depreciation-timing wedge; neoclouds squeezed, hyperscalers expanding), not gross. Replaces the stale Oracle 30-40% figure. |
