...
Claim IDs use the next free contiguous block above the prior global maximum (COMM-624, held by [`iridium_acquisition.md`](../rocket_lab/iridium_acquisition.md)). This doc uses **COMM-625..634** (10 hard claims). The fundamentals companion reserved COMM-561..600 and used 561..574; the Iridium doc used 601..624; no collision.
