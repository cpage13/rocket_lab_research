...
1. **The premium/sovereign niche is real money but an order of magnitude smaller than the mass-market connectivity TAM.** Adding the relevant total-spend pools (government and military satcom, the premium enterprise verticals of maritime, aero, and critical-infrastructure/finance, plus the emerging orbital-DC backhaul) gives a **total premium/sovereign spend pool of roughly $60-95B/yr today**: about **$60-70B is sourced bottom-up** from the component lines below [ESTIMATE], and the top of the span (up to ~$95B) is an **estimated ceiling, not a sourced figure**. That is a real, durable, defense-and-government-anchored market, but it is about **6-7% the size of the ~$1.6T cited connectivity TAM** and roughly **60-75% the size of the ~$129B realistic broad-LEO served estimate** in the base. The premium niche is not bigger than the mass market; it is smaller, higher-margin, and harder to win.
...
The honest one-line read: **the premium/sovereign niche is a roughly $60-95B/yr total spend pool (~$60-70B sourced bottom-up, up to ~$95B an estimated ceiling), of which maybe $8-30B/yr is realistically open to a new commercial services entrant after closed national programs are removed, split across many operators, at margins materially better than mass-market connectivity but at a fraction of its size.**
